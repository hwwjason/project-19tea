...
public class SaleOrderDetailEntity {
	...
	private float TradeOriginalPrice ;
	...
	void setPtypeId(String PtypeId) {
	...
	public void setTradeOriginalPrice(float TradeOriginalPrice) {
		this.TradeOriginalPrice = TradeOriginalPrice;
	}
	public float getTradeOriginalPrice() {
