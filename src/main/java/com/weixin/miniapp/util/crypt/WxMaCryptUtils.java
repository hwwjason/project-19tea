package com.weixin.miniapp.util.crypt;

import com.weixin.miniapp.config.WxMaConfig;
import com.weixin.common.util.crypto.PKCS7Encoder;
 ...
 */
public class WxMaCryptUtils extends com.weixin.common.util.crypto.WxCryptUtil {
