(function($) {
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: 'https://www.sowtea.com:2433/bak/image/uploadImage',
            // runtimeOrder: 'flash',
        ...
        uploader.on('ready', function() {
            ...
            if (GetRequest().id != undefined) {
                ...
                var slideimg = "";
                $.post(baseURL + "bak/product/getProductById", idobj, function(res) {
                    if (res.status == "1") {
                        var resdata = res.data;
                        slideimg = res.data.slideImgs;
                        //编辑状态
                        ...
                        ue.addListener("ready", function() {
                            ue.setContent(resdata.introduce)
                        });
                    }
                }, "json")
        ...
        function editFile(file) {
            ...
            var $li = $('<li id="' + file.id + '" class="ui-state-default">' +
                    ...
                    ' +
                    '<input name="slideImg[]" type="hidden" class="list1SortOrder" value=' + file.filename + '>' +
                    '</li>'),
        ...
        uploader.on('uploadSuccess', function(file, response) {
            ...
            if (data.hasOwnProperty('error')) {
                ...
                //商品发布需要的img地址
                var append_img = '<input name="slideImg[]" type="hidden" class="list1SortOrder" value=' + data.path + '>';
                var $li = $('#' + file.id);
